  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <div style={styles.subtitle}>Define connections between seed entities.</div>
      </div>
      ...
      <div style={styles.toolbar}>
        ...
        {entities.length < 2 && (
          <span style={{ color: "#93c5fd", fontSize: "12px" }}>Need at least 2 entities</span>
        )}
            ...
            {filteredRels.map((rel, idx) => (
              <tr key={`${rel.kind}-${rel.src}-${rel.dst}-${idx}`}>
                ...
                <td style={{ ...styles.td, width: "80px" }}>
                  <button style={styles.deleteButton} onClick={() => deleteRelationship(rel)}>
                    Delete
                  </button>
                </td>
              </tr>
