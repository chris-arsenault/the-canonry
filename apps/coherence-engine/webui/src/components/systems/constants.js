...
export const SYSTEM_TYPES = {
  eraSpawner: {
    ...
    icon: "🕰️",
    color: "#fbbf24",
    desc: "Creates era entities at simulation start",
  },
  eraTransition: {
    label: "Era Transition",
    icon: "⏭️",
    color: "#fbbf24",
    desc: "Handles era progression",
  },
  universalCatalyst: {
    label: "Agent Actions",
    icon: "🎭",
    color: "#fbbf24",
    desc: "Agent action system",
  },
  relationshipMaintenance: {
    label: "Relationship Maintenance",
    icon: "🔧",
    color: "#60a5fa",
    desc: "Relationship decay/reinforcement",
  },
  graphContagion: {
    label: "Graph Contagion",
    icon: "🦠",
    color: "#f87171",
    desc: "Spreads states through connections",
  },
  connectionEvolution: {
    label: "Connection Evolution",
    icon: "🔗",
    color: "#60a5fa",
    desc: "Relationship changes over time",
  },
  thresholdTrigger: {
    label: "Threshold Trigger",
    icon: "⚡",
    color: "#4ade80",
    desc: "Condition detection and actions",
  },
  clusterFormation: {
    label: "Cluster Formation",
    icon: "🎯",
    color: "#c084fc",
    desc: "Groups entities into meta-entities",
  },
  tagDiffusion: {
    label: "Tag Diffusion",
    icon: "🏷️",
    color: "#f472b6",
    desc: "Tag spreading between entities",
  },
  planeDiffusion: {
    label: "Plane Diffusion",
    icon: "🌡️",
    color: "#38bdf8",
    desc: "Value diffusion across space",
  },
};
...
export const METRIC_TYPES = [
  {
    ...
    desc: "Total relationships involving entity",
  },
  {
    value: "relationship_count",
    label: "Relationship Count",
    desc: "Count of specific relationship kind(s)",
  },
  {
    value: "shared_relationship",
    label: "Shared Relationship",
    desc: "Count entities sharing a specific relationship",
  },
  {
    value: "neighbor_prominence",
    label: "Neighbor Prominence",
    desc: "Average prominence of connected entities",
  },
];
