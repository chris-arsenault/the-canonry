    ...
    <div className="weight-matrix-editor">
                ...
                return (
                  ...
                  >
                    ...
                    {eras.map((era) => {
                      ...
                      const isEditing =
                        editingCell?.rowId === item.id && editingCell?.eraId === era.id;
                      ...
                      return (
                        ...
                        >
                          {isEditing ? (
                            ...
                            <span className="cell-value" style={{ color: getTextColor(weight) }}>
                              {weight !== null ? weight : "-"}
                            </span>
                          )}
                        </td>
      ...
      <div className="matrix-legend">
        ...
        <div className="legend-scale">
          <span className="legend-item" style={{ backgroundColor: getHeatmapColor(0) }}>
            0
          </span>
          <span className="legend-item" style={{ backgroundColor: getHeatmapColor(2.5) }}>
            2.5
          </span>
          <span className="legend-item" style={{ backgroundColor: getHeatmapColor(5) }}>
            5
          </span>
          <span className="legend-item" style={{ backgroundColor: getHeatmapColor(7.5) }}>
            7.5
          </span>
          <span className="legend-item" style={{ backgroundColor: getHeatmapColor(10) }}>
            10
          </span>
        </div>
