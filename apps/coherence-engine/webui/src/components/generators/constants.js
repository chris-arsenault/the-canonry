...
export const APPLICABILITY_TYPES = {
  pressure: {
    ...
    icon: "🌡️",
    color: "#f59e0b",
    desc: "Pressure within a range",
  },
  pressure_any_above: {
    label: "Any Pressure Above",
    icon: "🌡️",
    color: "#f97316",
    desc: "Any pressure exceeds threshold",
  },
  pressure_compare: {
    label: "Pressure Compare",
    icon: "⚖️",
    color: "#eab308",
    desc: "Compare two pressures",
  },
  entity_count: {
    label: "Entity Count",
    icon: "📊",
    color: "#3b82f6",
    desc: "Count entities by kind",
  },
  relationship_count: {
    label: "Relationship Count",
    icon: "🔗",
    color: "#8b5cf6",
    desc: "Count relationships",
  },
  relationship_exists: {
    label: "Relationship Exists",
    icon: "🔍",
    color: "#7c3aed",
    desc: "Check for relationship",
  },
  ...
  time_elapsed: {
    ...
    icon: "⏱️",
    color: "#06b6d4",
    desc: "Time since creation/update",
  },
  growth_phases_complete: {
    label: "Growth Phases Complete",
    icon: "🌱",
    color: "#22c55e",
    desc: "N growth phases completed in era",
  },
  era_match: {
    label: "Era Match",
    icon: "🕰️",
    color: "#10b981",
    desc: "Only runs in specific eras",
  },
  random_chance: {
    label: "Random Chance",
    icon: "🎲",
    color: "#a855f7",
    desc: "Runs with a probability",
  },
  cooldown_elapsed: {
    label: "Cooldown",
    icon: "⏱️",
    color: "#0ea5e9",
    desc: "Wait N ticks since last run",
  },
  creations_per_epoch: {
    label: "Rate Limit",
    icon: "📈",
    color: "#f97316",
    desc: "Max creations per epoch",
  },
  graph_path: {
    label: "Graph Path",
    icon: "🔀",
    color: "#ec4899",
    desc: "Path traversal condition",
  },
  entity_exists: {
    label: "Entity Exists",
    icon: "👤",
    color: "#14b8a6",
    desc: "Entity reference resolves",
  },
  entity_has_relationship: {
    label: "Entity Has Relationship",
    icon: "🧷",
    color: "#0f766e",
    desc: "Entity has relationship",
  },
  ...
  and: {
    ...
    icon: "🔗",
    color: "#14b8a6",
    desc: "Passes if all sub-rule passes",
  },
...
export const FILTER_TYPES = {
  ...
  has_tags: {
    ...
    icon: "🏷️",
    color: "#059669",
    desc: "Entity has ALL specified tags (AND)",
  },
  has_any_tag: {
    label: "Has Any Tag",
    icon: "🏷️",
    color: "#10b981",
    desc: "Entity has at least ONE of the tags (OR)",
  },
  lacks_tag: {
    label: "Lacks Tag",
    icon: "🚫",
    color: "#dc2626",
    desc: "Entity does NOT have a specific tag",
  },
  lacks_any_tag: {
    label: "Lacks Any Tag",
    icon: "🚫",
    color: "#b91c1c",
    desc: "Entity does NOT have ANY of these tags",
  },
  // Attribute filters
  has_culture: {
    label: "Has Culture",
    icon: "🌍",
    color: "#6366f1",
    desc: "Entity belongs to a specific culture",
  },
  matches_culture: {
    label: "Matches Culture",
    icon: "🤝",
    color: "#7c3aed",
    desc: "Entity has same culture as another entity",
  },
  has_status: {
    label: "Has Status",
    icon: "📊",
    color: "#0891b2",
    desc: "Entity has a specific status",
  },
  has_prominence: {
    label: "Min Prominence",
    icon: "⭐",
    color: "#eab308",
    desc: "Entity has at least this prominence level",
  },
  ...
  has_relationship: {
    ...
    icon: "🔗",
    color: "#8b5cf6",
    desc: "Entity has a relationship of this kind",
  },
  lacks_relationship: {
    label: "Lacks Relationship",
    icon: "🚫",
    color: "#ef4444",
    desc: "Entity lacks a relationship of this kind",
  },
  shares_related: {
    label: "Shares Related Entity",
    icon: "📍",
    color: "#3b82f6",
    desc: "Both entities have same related entity via relationship",
  },
  // Other
  exclude: {
    ...
    icon: "⛔",
    color: "#f59e0b",
    desc: "Exclude specific entity references",
  },
  graph_path: {
    label: "Graph Path",
    icon: "🔀",
    color: "#ec4899",
    desc: "Complex multi-hop graph traversal",
  },
};
