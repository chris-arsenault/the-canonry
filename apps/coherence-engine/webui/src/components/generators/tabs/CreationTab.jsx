      ...
      >
        ...
        <div className="item-card-info">
          ...
          <div className="item-card-subtitle">
            {safeDisplay(item.kind, "?", "kind")}:{subtypeDisplay} •{" "}
            {safeDisplay(item.prominence, "no prominence", "prominence")}
          </div>
              ...
              {placement?.anchor?.type === "entity" && (
                <div className="form-grid mt-lg">
                  <ReferenceDropdown
                    ...
                    placeholder={
                      sameKindRefs.length > 0 ? "Select..." : `Define a ${item.kind} variable first`
                    }
                  />
                  <div className="form-group">
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) =>
                          setAnchor({ ...placement.anchor, stickToRegion: e.target.checked })
                        }
                      />
                      Stick to Region
                    </label>
                ...
                <div className="form-grid mt-lg">
                  ...
                  <div className="form-group">
                    ...
                    <NumberInput
                      ...
                      onChange={(v) =>
                        setAnchor({ ...placement.anchor, jitter: v === "" ? undefined : Number(v) })
                      }
                      min={0}
                      step={1}
                      placeholder="0"
                  ...
                  <div className="form-group">
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) =>
                          setAnchor({ ...placement.anchor, preferPeriphery: e.target.checked })
                        }
                      />
                      Prefer Periphery
                    </label>
                ...
                <>
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      <label className="checkbox-label">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setRegionPolicy({
                              ...current,
                              allowEmergent: allowEmergent || undefined,
                            });
                          }}
                        />
                      ...
                      <div className="hint">
                        When enabled, creates new regions when existing regions are at capacity
                      </div>
                    </div>
                    <div className="form-group">
                      <label className="checkbox-label">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setRegionPolicy({
                              ...current,
                              createRegion: createRegion || undefined,
                            });
                          }}
                        />
                      ...
                      <div className="hint">
                        Creates a new region centered on the placed entity (useful for establishing
                        new territories)
                      </div>
                    </div>
                    <div className="form-group">
                      <label className="checkbox-label">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setRegionPolicy({
                              ...current,
                              preferSparse: preferSparse || undefined,
                            });
                          }}
                        />
                      ...
                      <div className="hint">
                        Bias region selection toward regions with fewer entities (weighted random
                        selection)
                      </div>
                    </div>
                  </div>
        ...
        onChange={(type) => {
          if (type === "pressure")
            ...
            setCondition({
              ...
              pressureA: pressureOptions[0]?.value || "",
              pressureB: pressureOptions[1]?.value || "",
              operator: ">",
            });
          else if (type === "entity_count")
            setCondition({
              type: "entity_count",
              kind: entityKindOptions[0]?.value || "npc",
              min: 1,
            });
          else if (type === "tag_exists")
            setCondition({ type: "tag_exists", entity: "$target", tag: "" });
  ...
  return (
    <div className="section mt-2xl">
      ...
      <div className="section-desc">
        Define variants that modify tags or pressure effects based on world state. This allows a
        single template to produce different outcomes depending on conditions.
      </div>
        ...
        variants.options.map((variant, idx) => (
          <VariantCard
            ...
            onRemove={() => {
              updateVariants({
                ...variants,
                options: variants.options.filter((_, i) => i !== idx),
              });
            }}
            pressureOptions={pressureOptions}
            entityKindOptions={entityKindOptions}
