...
export const CONDITION_TYPES = [
  {
    value: "growth_phases_complete",
    label: "Growth Phases Complete",
    description: "Transition after N growth phases",
  },
  ...
  { value: "entity_count", label: "Entity Count", description: "Based on entity population" },
  {
    ...
    description: "Based on relationships",
  },
  {
    value: "relationship_exists",
    label: "Relationship Exists",
    description: "Based on a relationship",
  },
