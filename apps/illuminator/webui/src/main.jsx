  ...
  cultures: [
    {
      id: "northern",
      name: "Northern Realm",
      description: "Hardy folk from the frozen north",
      color: "#60a5fa",
    },
    {
      id: "southern",
      name: "Southern Empire",
      description: "Sophisticated traders of the south",
      color: "#f59e0b",
    },
  ],
});
...
const mockWorldData = Object.freeze({
  ...
  hardState: [
    ...
    },
    {
      ...
      kind: "npc",
      subtype: "hero",
      name: "Silverfin the Swift",
      description: "",
      status: "active",
      prominence: 3.5,
      culture: "southern",
      tags: {},
      coordinates: { x: 60, y: 40, z: 5 },
      createdAt: 2,
      updatedAt: 8,
    },
    {
    ...
    },
    {
      ...
      kind: "faction",
      subtype: "nation",
      name: "The Ice Confederacy",
      description: "",
      status: "active",
      prominence: 3.5,
      culture: "northern",
      tags: {},
      coordinates: { x: 40, y: 50, z: 8 },
      createdAt: 3,
      updatedAt: 12,
    },
  ],
