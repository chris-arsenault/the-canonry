...
export const THINKING_CAPABLE_MODELS = ["claude-opus-4-6", "claude-sonnet-4-6"];
...
export const LLM_CALL_METADATA: Record<LLMCallType, LLMCallMetadata> = {
  ...
  "chronicle.copyEdit": {
    label: "Copy-Edit",
    description:
      "Polish pass — smooths voice, trims to word count, tightens prose without changing content",
    category: "chronicle",
    defaults: {
      model: "claude-sonnet-4-6",
      thinkingBudget: 0,
  ...
  "chronicle.quickCheck": {
    label: "Quick Check",
    description:
      "Detects unanchored entity references — proper nouns not in the known cast or name bank",
    category: "chronicle",
    defaults: {
      model: "claude-haiku-4-5-20251001",
      thinkingBudget: 0,
  ...
  "chronicle.bulkToneRanking": {
    ...
    description:
      "Batch tone ranking — all chronicles evaluated in a single call with relative comparison",
    category: "chronicle",
    defaults: {
      model: "claude-sonnet-4-6",
  ...
  "revision.loreBackport": {
    label: "Lore Backport",
    description:
      "Extracts lore from published chronicles and backports to entity summaries/descriptions",
    category: "revision",
    defaults: {
      model: "claude-sonnet-4-6",
      thinkingBudget: 4096,
  ...
  "historian.entityReview": {
    ...
    description:
      "Historian margin notes on an entity description — scholarly commentary, factual corrections, tongue-in-cheek observations",
    category: "historian",
    defaults: {
      model: "claude-sonnet-4-6",
      thinkingBudget: 4096,
  ...
  "historian.chronicleReview": {
    ...
    description:
      "Historian margin notes on a chronicle narrative — scholarly footnotes, disputed accounts, color commentary",
    category: "historian",
    defaults: {
      model: "claude-sonnet-4-6",
      thinkingBudget: 4096,
  ...
  "historian.edition": {
    label: "Copy Edit",
    description:
      "Historian-voiced rewrite of entity description from the full description archive — scholarly synthesis with editorial discretion",
    category: "historian",
    defaults: {
      model: "claude-sonnet-4-6",
      thinkingBudget: 4096,
  ...
  "historian.chronology": {
    label: "Chronology",
    description:
      "Historian assigns year numbers to chronicles within an era, establishing chronological ordering",
    category: "historian",
    defaults: {
      model: "claude-sonnet-4-6",
      thinkingBudget: 8192,
  ...
  "historian.eraNarrative.threads": {
    ...
    description:
      "Thread synthesis: identify cultural arcs, movement plan, thesis, and motifs from prep briefs",
    category: "historian",
    defaults: {
      model: "claude-opus-4-6",
      thinkingBudget: 16384,
  ...
  "historian.eraNarrative.generate": {
    ...
    description:
      "Prose generation: write the era narrative (5,000-7,000 words) from thread synthesis",
    category: "historian",
    defaults: {
      model: "claude-opus-4-6",
      thinkingBudget: 16384,
  ...
  "historian.eraNarrative.imageRefs": {
    ...
    description:
      "Places image references throughout the era narrative, referencing chronicle images or generating new scenes",
    category: "historian",
    defaults: {
      model: "claude-haiku-4-5-20251001",
      thinkingBudget: 0,
