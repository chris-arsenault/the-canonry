    ...
    >
      ...
      <div className="hrm-note-header">
        <div className="hrm-note-header-left">
          <span
            className="hrm-note-type-icon"
            // eslint-disable-next-line local/no-inline-styles -- dynamic color from note type meta
            style={{ color: meta.color }}
          >
            {meta.icon}
          </span>
          <span
            className="hrm-note-type-label"
            // eslint-disable-next-line local/no-inline-styles -- dynamic color from note type meta
            style={{ color: meta.color }}
          >
            {meta.label}
...
function AnnotatedText({ sourceText, notes, noteDecisions }) {
  ...
  return (
    <div className="hrm-annotated-text">
      {segments.map((seg, i) => {
        if (seg.type === "text") {
        ...
        return (
          ...
          >
            {seg.content}
            <sup
              className="hrm-anchor-sup"
              // eslint-disable-next-line local/no-inline-styles -- dynamic color from note type meta
              style={{ color: seg.meta.color }}
            >
              {seg.meta.icon}
            </sup>
          </span>
