                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                    {synthesis.inputFacts.map((fact, i) => (
                      ...
                      >
                        ...
                        <div style={{ color: "var(--text-secondary)" }}>{fact.text}</div>
                      </div>
                    ))}
                  </div>
                </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontSize: "10px", color: "var(--text-muted)", display: "flex", gap: "10px" }}
        >
          {RATING_ORDER.map((r) => (
            <span key={r}>
          ...
          <div key={ci}>
            {col.map((entry) => {
              ...
              return (
                ...
                >
                  <span style={{ color: rs.color, fontWeight: 600, flexShrink: 0 }}>
                    {rs.symbol}
                  </span>
                  <span
                    style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: "13px", fontWeight: 500 }}>Fact Coverage</span>
        <span style={{ fontSize: "11px", color: "var(--text-muted)", marginLeft: "auto" }}>
          {RATING_ORDER.map((r) =>
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                  <span
                    style={{ color: style.color, fontWeight: 600, flexShrink: 0 }}
                    title={style.label}
                  >
                    {style.symbol}
                  </span>
        ...
        <>
          {onUpdateTemporalContext && (
            <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", alignItems: "center" }}>
              <div style={{ fontSize: "12px", color: "var(--text-muted)" }}>Focal Era</div>
              <select
                value={selectedEraId}
          ...
          <div style={{ marginTop: "10px", fontSize: "12px", color: "var(--text-secondary)" }}>
            ...
            {focalEra?.summary && (
              <div>
                <span style={{ color: "var(--text-muted)" }}>Era Summary:</span> {focalEra.summary}
              </div>
            )}
            ...
            {tickRange && (
              <div>
                <span style={{ color: "var(--text-muted)" }}>Tick Range:</span> {tickRange[0]}
                &ndash;{tickRange[1]}
              </div>
            )}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    color: "var(--text-secondary)",
                    cursor:
                      isGenerating || temporalCheckRunning || !item.assembledContent
                        ? "not-allowed"
                        : "pointer",
                    opacity:
                      isGenerating || temporalCheckRunning || !item.assembledContent ? 0.6 : 1,
                    fontSize: "11px",
                  }}
                >
