...
function ScoreGauge({ score }) {
  ...
  return (
    <div style={{ position: "relative", width: "120px", height: "120px" }}>
      ...
      >
        <div style={{ fontSize: "28px", fontWeight: 700, color: getColor() }}>{score}</div>
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <span style={{ fontSize: "13px", fontWeight: isSection ? 400 : 500 }}>{label}</span>
        </div>
        {check.notes && (
            ...
            >
              <div
                style={{
                  fontSize: "24px",
                  fontWeight: 700,
                  color: report.checks.plotStructure.pass ? "#10b981" : "#ef4444",
                }}
              >
            ...
            >
              <div
                style={{
                  fontSize: "24px",
                  fontWeight: 700,
                  color: report.checks.entityConsistency.pass ? "#10b981" : "#ef4444",
                }}
              >
            ...
            >
              <div
                style={{
                  fontSize: "24px",
                  fontWeight: 700,
                  color: report.checks.resolution.pass ? "#10b981" : "#ef4444",
                }}
              >
