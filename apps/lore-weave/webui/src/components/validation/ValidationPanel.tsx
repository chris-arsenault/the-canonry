...
interface DomainSchema {
  ...
  entityKinds: Array<{ kind: string }>;
  relationshipKinds: Array<{ kind: string }>;
}
...
function WarningCard({ warning }: Readonly<{ warning: SchemaWarning }>) {
  return (
...
export default function ValidationPanel({
  ...
  const { valid, errors, warnings } = validationResult as { valid: boolean; errors: SchemaError[]; warnings: SchemaWarning[] };
    ...
    <div className="validation-panel-container">
      ...
      <div className="validation-panel-stats">
        <div className="validation-panel-stat-card">
          <div className="validation-panel-stat-value">{generators.length}</div>
          <div className="validation-panel-stat-label">Generators</div>
        </div>
        <div className="validation-panel-stat-card">
          <div className="validation-panel-stat-value">{pressures.length}</div>
          <div className="validation-panel-stat-label">Pressures</div>
        </div>
        <div className="validation-panel-stat-card">
          <div className="validation-panel-stat-value">{systems.length}</div>
          <div className="validation-panel-stat-label">Systems</div>
        </div>
        <div className="validation-panel-stat-card">
          <div className="validation-panel-stat-value">{actions.length}</div>
          <div className="validation-panel-stat-label">Actions</div>
        </div>
        <div className="validation-panel-stat-card">
          <div className="validation-panel-stat-value">{eras.length}</div>
          <div className="validation-panel-stat-label">Eras</div>
        </div>
        <div className="validation-panel-stat-card">
          <div className="validation-panel-stat-value">{seedEntities.length}</div>
