                ...
                <input
                  ...
                  onBlur={(e) =>
                    setFormData({
                      ...
                      phonology: {
                        ...formData.phonology,
                        syllableTemplates: e.target.value.split(/\s+/).filter((s) => s),
                      },
                    })
                  }
                  ...
                  <NumberInput
                    ...
                    onChange={(v) =>
                      setFormData({
                        ...
                        phonology: {
                          ...formData.phonology,
                          lengthRange: [v ?? 2, formData.phonology?.lengthRange?.[1] || 4],
                        },
                      })
                    }
                    integer
                  ...
                  <NumberInput
                    ...
                    onChange={(v) =>
                      setFormData({
                        ...
                        phonology: {
                          ...formData.phonology,
                          lengthRange: [formData.phonology?.lengthRange?.[0] || 2, v ?? 4],
                        },
                      })
                    }
                    integer
                ...
                <input
                  ...
                  onBlur={(e) =>
                    setFormData({
                      ...
                      phonology: {
                        ...formData.phonology,
                        favoredClusters: e.target.value.split(/\s+/).filter((s) => s),
                      },
                    })
                  }
                ...
                <input
                  ...
                  onBlur={(e) =>
                    setFormData({
                      ...
                      phonology: {
                        ...formData.phonology,
                        forbiddenClusters: e.target.value.split(/\s+/).filter((s) => s),
                      },
                    })
                  }
                ...
                <input
                  ...
                  onBlur={(e) =>
                    setFormData({
                      ...
                      morphology: {
                        ...formData.morphology,
                        prefixes: e.target.value.split(/\s+/).filter((s) => s),
                      },
                    })
                  }
                ...
                <input
                  ...
                  onBlur={(e) =>
                    setFormData({
                      ...
                      morphology: {
                        ...formData.morphology,
                        suffixes: e.target.value.split(/\s+/).filter((s) => s),
                      },
                    })
                  }
                ...
                <input
                  ...
                  onBlur={(e) =>
                    setFormData({
                      ...
                      style: {
                        ...formData.style,
                        preferredEndings: e.target.value.split(/\s+/).filter((s) => s),
                      },
                    })
                  }
