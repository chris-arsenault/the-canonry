...
export const LEXEME_CATEGORIES = {
  ...
  core: {
    label: "Core Word",
    desc: "Short, concrete Germanic-root words (monosyllabic, visceral, dual-use)",
  },
  ...
  collective: {
    label: "Collective",
    desc: "Group type words (guild, order, brotherhood, council, syndicate)",
  },
  organization: {
    label: "Organization",
    desc: "Formal group names (company, house, clan, legion)",
  },
};
